 ...
 */
class Sqaime_CouponAssign_Block_Adminhtml_Edit_Tab_Main
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('couponassign', 'text', array(
                    'label'     => Mage::helper('salesrule')->__('Assign to UserId'),
                    'title'     => Mage::helper('salesrule')->__('Assign to UserId'),
                    'name'      => 'couponassign',
        ));
